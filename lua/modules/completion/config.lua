...
function config.aerial() require("aerial").setup({}) end
...
function config.cmp()
    ...
    function cmp_window:has_scrollbar() return false end
...
function config.luasnip()
    vim.o.runtimepath = vim.o.runtimepath .. "," .. os.getenv("HOME") ..
...
function config.mason_install()
    require("mason-tool-installer").setup({
        ...
        ensure_installed = {
            ...
            "editorconfig-checker", "stylua", "black", "prettier", "shellcheck",
            "shfmt", "vint"
        },
