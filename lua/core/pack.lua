...
function Packer:init_ensure_plugins()
    ...
    if not state then
        local cmd = "!git clone git@github.com:wbthomason/packer.nvim.git " ..
                        packer_dir
...
function plugins.load_compile()
    ...
    vim.cmd(
        [[autocmd User PackerComplete lua require('core.pack').back_compile()]])
    vim.cmd(
        [[command! PackerStatus lua require('core.pack').compile() require('packer').status()]])
end
